---
    ...
    categories: [Coding]
    cover: /svelte-logo-square.png
---

# Svelte is like vanilla JavaScript, but better.

JavaScript. A programming language that no one likes to write vanilla code for. It's not abstract or fun to use vanilla JavaScript when making a website.
...
instead. HTML IDs are _specific_ on what you are trying to grab from the DOM (Document Object Model)
...
React JSX is more so its own thing than Vanilla JS.
